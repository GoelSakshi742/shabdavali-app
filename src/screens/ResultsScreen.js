    ...
    <SafeAreaView style={s.safe}>
      <ScrollView contentContainerStyle={s.scroll}>
        ...
        <View style={s.statsGrid}>
          <View style={s.statBox}><Text style={[s.statN,{color:COLORS.greenLight}]}>{score.right}</Text><Text style={s.statL}>Correct</Text></View>
          <View style={s.statBox}><Text style={[s.statN,{color:COLORS.red}]}>{score.wrong}</Text><Text style={s.statL}>Review</Text></View>
          <View style={s.statBox}><Text style={[s.statN,{color:COLORS.accent}]}>{total}</Text><Text style={s.statL}>Total</Text></View>
          <View style={s.statBox}><Text style={s.statN}>{pct}%</Text><Text style={s.statL}>Accuracy</Text></View>
        </View>
